const TextoProgramador = () => {
  return (
    <div>
      ...
      <p className=" text-justify pb-2">
        A lo largo del 2020, ahondé en mis estudios sobre programación y ciencia
        de datos empleando Python y R. Creando interfaces de usuario para
        proyectos de ciencia de datos, descubrí que me fascina el desarrollo web
        front-end. En 2021 me dediqué a aprender las bases de programación web
        (HTML, CSS, JavaScript) así como el framework React.
      </p>
